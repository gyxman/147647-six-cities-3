...
export class PlaceCard extends PureComponent {
  ...
  render() {
    const {onOfferTitleHover, onOfferTitleClick, offer, className, onBookmarkButtonClick, isFavorite} = this.props;
      ...
      >
        ...
        <div className="place-card__info">
          <div className="place-card__price-wrapper">
            ...
            <button className={`place-card__bookmark-button button ` + (isFavorite ? `place-card__bookmark-button--active` : ``)} type="button" onClick={() => onBookmarkButtonClick(offer.id)}>
